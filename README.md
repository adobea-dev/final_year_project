...
This project is AI system that continuously monitors dealer data, reasons about it, and recommends actions to account managers in my company (Autochek Ghana)
The agentic ai comprises of the; 
...
iv. Action & Communication Layer
This is the interface where users (account managers) interact with the AI. This is where the chatbot fits in. It’s the gateway that allows a human to query, understand, and command your agentic AI.
